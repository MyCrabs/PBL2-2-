...
void Room::show() {
	cout << "| " << setw(10) << this->ma_phong << " | " << setw(20) << this->ten << " | ";
	cout << setw(15) << this->SDT << " | ";
	cout << setw(12) << this->trang_thai_phong << "    | " << setw(10) << this->loai_phong << "   | " << *this->ngay_thue;
	cout << setw(5) << day_now() - this->ngay_thue->get_ngay_thue() << " |" ;
...
int Room::tinh_tien() {
	return this->he_So_gia * gcb * (day_now() - this->ngay_thue->get_ngay_thue());
}
