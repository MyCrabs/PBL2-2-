...
void List1::display_list() {
	...
	cout << setw(50) << "" << "--------------------------------------------------------------------------------------------------------------------------------" << endl;
	cout << setw(50) << "" << "|" << setw(8) << " | " << setw(13) << " | " << setw(23) << " | " << setw(18) << " | " << setw(18) << " | " << setw(15) << " | " << setw(17) << "|" << setw(7) << "   |" << setw(7) << "   |"<<endl;
	cout << setw(50) << "" << "|" << setw(5) << "STT" << " | " << setw(10) << "MA PHONG" << " | " << setw(20) << "HO VA TEN KH" << " | " << setw(15) << "SDT" << " | " << setw(12) << "TRANG THAI PHONG" << "| " << setw(12) << "LOAI PHONG" << " | " << setw(15) << "NGAY THUE" << " |" << setw(5) << "SO NGAY" << setw(3) << "  TIEN" << "|" << endl;
	cout << setw(50) << "" << "|" << setw(8) << " | " << setw(13) << " | " << setw(23) << " | " << setw(18) << " | " << setw(18) << " | " << setw(15) << " | " << setw(17) << "|" << setw(7) << "   |" << setw(7) << "   |"<< endl;
	cout << setw(50) << "" << "--------------------------------------------------------------------------------------------------------------------------------" << endl;
	int stt = 1;
	while (current_room != nullptr) {
...
void List1::print_statistics() {
	...
	cout << setw(50) << "" << "Tong sale hien tai: " << tong_thuc_linh << "  USD" << endl;
}
...
void List1::run() {
	...
	while (true) {
		...
		else if (choice == 4)
		{
			...
			cout << setw(70) << "" << "|--------------------------------------------------------------------------------|" << endl << setw(71) << "|" << setw(81) << "|" << endl;
			cout << setw(71) << "|" << setw(30) << "Danh sach cac lua chon:" << setw(51) << "|" << endl;
			cout << setw(71) << "|" << setw(30) << "" << "1. Tim kiem theo ma phong" << setw(26) << "|" << endl;
			cout << setw(71) << "|" << setw(30) << "" << "2. Tim kiem theo ten khach hang" << setw(20) << "|" << endl;
			cout << setw(71) << "|" << setw(30) << "" << "3. Tim kiem theo tinh trang phong" << setw(18) << "|" << endl;
			cout << setw(71) << "|" << setw(30) << "" << "4. Tim kiem theo loai phong" << setw(24) << "|" << endl;
			cout << setw(71) << "|" << setw(30) << "" << "0. Quay tro lai menu chinh" << setw(25) << "|" << endl;
			cout << setw(70) << "" << "----------------------------------------------------------------------------------" << endl << endl;
			cout << setw(103) << "> ";
			cin >> search_choice;
